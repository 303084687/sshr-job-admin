...
import com.ctgtmo.sshr.core.trigger.XxlJobTrigger;
...
public class JobTriggerPoolHelper {
  ...
  public void start() {
    fastTriggerPool = new ThreadPoolExecutor(10, XxlJobAdminConfig.getAdminConfig().getTriggerPoolFastMax(), 60L, TimeUnit.SECONDS,
